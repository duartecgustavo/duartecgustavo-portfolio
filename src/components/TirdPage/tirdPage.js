    ...
    return (
        <>
            <div className="d-flex row">
                ...
                <div className="py-3 workspaceTP">
                    <img className="img-fluid imgbg" src={bg3} alt="" />
                    <div className="container-fluid d-flex h-100">
                        <div className="col-6" data-aos="fade-right">
                            ...
                            <div className="d-flex flex-column align-items-center justify-content-center" style={{ height: "28vh" }}>
